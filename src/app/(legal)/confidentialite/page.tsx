  ...
  return (
    ...
    >
      ...
      <LegalSection id="responsable" title="1. Responsable du traitement">
        <p>
          Le responsable du traitement des données personnelles collectées via RideCloud est <strong>JavaChrist</strong>, entrepreneur individuel, dont les coordonnées complètes figurent dans les <a href="/mentions-legales" className="text-blue-700 hover:underline">mentions légales</a>.
        </p>
        <p>
          Adresse e-mail dédiée à la protection des données&nbsp;: <a href="mailto:support@javachrist.fr" className="text-blue-700 hover:underline">support@javachrist.fr</a>
        </p>
        <p>
      ...
      <LegalSection id="finalites" title="3. Finalités et bases légales">
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200/70 shadow-ride-xs">
