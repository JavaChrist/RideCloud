...
export function DeleteAccountSection({ email }: DeleteAccountSectionProps) {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden rounded-3xl border border-red-200/70 bg-gradient-to-br from-red-50/60 via-white to-white p-6 shadow-ride-sm md:p-8"
    >
      <div
        aria-hidden
      ...
      <div className="flex items-start gap-4">
        <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-red-200 bg-red-50 text-red-600 shadow-ride-xs">
          <AlertTriangle className="h-5 w-5" aria-hidden />
        </div>
        <div className="flex-1">
          <h2 id="delete-account-heading" className="text-lg font-semibold tracking-tight text-slate-900">
      ...
      {isOpen ? (
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-md overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
            <div className="flex items-start justify-between gap-4 border-b border-slate-200/80 bg-gradient-to-br from-red-50 to-white p-6">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-red-200 bg-white text-red-600 shadow-ride-xs">
                  <AlertTriangle className="h-5 w-5" aria-hidden />
                </div>
                <div>
            ...
            <div className="space-y-4 p-6">
              <p className="text-sm leading-relaxed text-slate-600">
                ...
                <strong className="text-slate-900"> {email}</strong> ainsi que toutes les
                données associées.
              </p>
              <div className="rounded-2xl border border-amber-200 bg-amber-50/70 p-3 text-sm text-amber-900">
